...
const EgestorERP = () => {
  ...
  const egestorLink = "https://www.egestor.com.br/afl/12782";
      ...
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-12 mb-10">
          ...
          <div className="md:w-1/2 rounded-xl overflow-hidden shadow-xl animate-fade-in">
            <video className="w-full aspect-video object-cover" autoPlay muted loop playsInline poster="/lovable-uploads/65e10f62-935e-44ea-a0e7-8cfd7222d1c8.png">
